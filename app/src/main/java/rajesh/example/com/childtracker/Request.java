...
public class Request extends ListActivity {
    ...
    // testing on Emulator:
    private static final String READ_REQUEST = "http://familytracker.netau.net/request.php";
    ...
    public void updateJSONdata() {
        ...
        JSONObject json = jParser.getJSONFromUrl(READ_REQUEST);
    ...
    private void updateList() {
        ...
        ListAdapter adapter = new SimpleAdapter(this, mCommentList,
                R.layout.single_request, new String[] {
                TAG_USERNAME }, new int[] {
                R.id.username });

       // Intent i = new Intent(Request.this, Permission.class);
       // i.putExtra("username", TAG_USERNAME);
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... arg0) {
            ...
            JSONObject json = jsonParser.makeHttpRequest(READ_REQUEST, "POST",
                    params);
